...
const SECTIONS = {
  ...
  "1 · Tool Calling":      { icon:"🛠️", accent:"#2e9e6b", tag:"The model requests, your code executes" },
  "2 · MCP":               { icon:"🔌", accent:"#5a7fd6", tag:"Reusable tools behind one protocol" },
  "3 · Agent Architectures": { icon:"🕸️", accent:"#c25a8a", tag:"One agent, many agents or a supervisor" },
  "4 · LangGraph":         { icon:"🔀", accent:"#7a5fd0", tag:"Explicit state, branches and bounded loops" },
