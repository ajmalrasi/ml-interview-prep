...
- **[Decision Tradeoffs — Why X over Y](decision-tradeoffs.md)** — every canonical head-to-head
  ("boosting or deep learning?", "RAG or fine-tune?", "spot or on-demand?") with the *deciding
  axis*, the default, and the cost of the wrong pick. This is the format senior interviewers
  push hardest on: not "what is X" but "X or Y, and why?"
